...
if (azf_debugmode) then {
	SystemChat "Reducer Enabled";
	player globalchat format ["azf_fnc_rInit DBG: Starting to track %1 groups, %2 range, %3 sleep", count allGroups, _range, f_var_reducerSleep];
	[] spawn {
